...
public final class DynamicNotch<Expanded, CompactLeading, CompactTrailing>: ObservableObject, DynamicNotchControllable where Expanded: View, CompactLeading: View, CompactTrailing: View {
    ...
    /// Optional decoration layer rendered with the notch (outside the pill mask).
    ///
    /// This is intended for effects like glows that should share the same coordinate space and animations
    ...
    /// Sets the decoration layer rendered with the notch (outside the pill mask).
    ///
